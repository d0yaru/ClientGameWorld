...
void SystemClass::InitializeWindows(int& screenWidth, int& screenHeight)
{
	...
	m_hwnd = CreateWindowEx(WS_EX_APPWINDOW, m_applicationName, m_applicationName, WS_OVERLAPPEDWINDOW | WS_VISIBLE, posX, posY, screenWidth, screenHeight, NULL, NULL, m_hinstance, NULL);
